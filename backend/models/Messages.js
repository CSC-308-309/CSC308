...
export const MessagesModel = {
    ...
    async createChat(chatData) {
        ...
        try {
            ...
            `;
            const chatResult = await pool.query(chatQuery, [is_group, name, created_by]);
    ...
    async sendMessage(chatId, messageData) {
        ...
        try {
            ...
            `;
            const messageResult = await pool.query(messageQuery, [chatId, sender_username, content]);
    ...
    async markChatRead(chatId, readData) {
        ...
        try {
            ...
            const { rows } = await pool.query(readQuery, [userId, chatId, readUntilId]);
