import { Home, User, MessageSquare, Bell, Calendar, Settings, LogOut, Mic } from 'lucide-react';
...
export default function Navbar() {
  return (
    ...
    >
      {/* Header */}
      <div className="flex items-center gap-3 p-6 border-b border-melodious-dark-purple">
      ...
      {/* Bottom Settings */}
      <div className="border-t border-melodious-dark-purple py-4">
